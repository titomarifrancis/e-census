insert into userlevels(userlevel, leveldesc, creationdate) values(1, 'Citizen', NOW());
insert into userlevels(userlevel, leveldesc, creationdate) values(2, 'Enumerator', NOW());
insert into userlevels(userlevel, leveldesc, creationdate) values(3, 'Administrator', NOW());
insert into userlevels(userlevel, leveldesc, creationdate) values(4, 'Super Administrator', NOW());
